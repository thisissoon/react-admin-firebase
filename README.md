# react-admin-firebase-flite

This fork allows images to be uploaded to storage in a format thats compatible with Flite, SOON_'s image transformer.

Installation is via github as this isn't published to NPM yet.
